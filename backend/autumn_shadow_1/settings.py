"""
Django settings for autumn_shadow_1 project.
...
ROOT_URLCONF = 'autumn_shadow_1.urls'
...
WSGI_APPLICATION = 'autumn_shadow_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "autumn_shadow_1 API",
    "DESCRIPTION": "API documentation for autumn_shadow_1 App",
    "VERSION": "v1",
}
